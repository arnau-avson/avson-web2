    ...
    <>
      ...
      <section className="section section--white">
        <div className="container">
          ...
          <p className="section__body">Si tu empresa está en cualquier otra ciudad andaluza o en el sur de España, Avson GRC puede atenderte con el mismo nivel de servicio. Consulta nuestra <Link to="/consultoria-ens-espana" style={{ color: 'var(--gold)', fontWeight: 500 }}>cobertura nacional completa</Link>.</p>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="faq-list">
            ...
            <div className="faq-item anim-fade-up">
              ...
              <div className="faq-item__a">
                <p>El coste es el mismo que en cualquier otra ciudad española: desde 4.000 € para ENS básico hasta más de 18.000 € para ENS alto. No aplicamos recargos por desplazamiento a Sevilla. El <Link to="/contacto" style={{ color: 'var(--gold)' }}>presupuesto sin compromiso</Link> incluye propuesta personalizada sin compromiso.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section section--navy">
        <div className="container" style={{ textAlign: 'center', maxWidth: '700px' }}>
          ...
          <p className="section__lead section__lead--white" style={{ margin: '0 auto 36px' }}>Escríbenos tu email y te enviamos un presupuesto sin compromiso en 48 horas. Reunión por videollamada o presencial en Sevilla.</p>
