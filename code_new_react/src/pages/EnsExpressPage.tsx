...
const faqItems = [
  {
    question: '¿El ENS Express garantiza ENS Básico, Medio o Alto?',
    answer: 'ENS Express cubre ENS Básico y ENS Medio. El ENS Alto requiere un análisis de seguridad más profundo que no puede completarse en 30 días sin comprometer la calidad del resultado. Si necesitas ENS Alto urgente, consúltanos — valoramos cada caso individualmente.'
  },
  {
    question: '¿Qué pasa si no conseguimos el certificado en 30 días?',
    answer: 'La garantía de éxito aplica también al Express. Si seguimos nuestra metodología y el plan de trabajo acordado y no superamos la auditoría, repetimos el proceso sin coste adicional. Esa es nuestra garantía por escrito, no una promesa de marketing.'
  },
  {
    question: '¿Qué necesito preparar antes de empezar?',
    answer: 'Muy poco. Necesitamos acceso a los sistemas en alcance, un interlocutor con autoridad para tomar decisiones, y disponibilidad para las reuniones diarias de 30 minutos. El resto lo gestionamos nosotros: documentación, implementación técnica, coordinación con la entidad auditora y respuesta a no conformidades.'
  },
  {
    question: '¿Funciona para cualquier sector?',
    answer: 'Sí. Hemos completado proyectos Express en sector TIC, defensa, sanidad y administración local. La categoría ENS que corresponde a tu organización la determinamos en el análisis inicial de las primeras 48 horas, antes de que empiece el trabajo intensivo.'
  },
  {
    question: '¿Cuánto cuesta ENS Express?',
    answer: 'El precio varía según la complejidad y el punto de partida de tu organización. El diagnóstico inicial es gratuito y te damos el presupuesto en la misma llamada. Como referencia, el Express tiene un sobrecoste del 50–70% sobre el servicio estándar, justificado por el equipo dedicado y la intensidad del proyecto. Cuando lo comparas con el valor del contrato público que estás en riesgo de perder, el retorno es inmediato.'
  }
]
      ...
      <section className="express-hero">
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ maxWidth: '700px' }}>
            ...
            <p className="subtitle"><strong>Pliego urgente. Equipo dedicado. Arranque en 24 horas.</strong><br />ENS Express garantiza el certificado en 30 días naturales con tres consultores exclusivos para tu proyecto. Sin excusas. Sin esperas.</p>
            <form onSubmit={handleHeroSubmit} style={{ display: 'flex', gap: '0', marginBottom: '16px', maxWidth: '480px', boxShadow: '0 4px 24px rgba(0,0,0,0.25)', borderRadius: '4px', animation: 'v3-gold-pulse 2.6s infinite' }}>
              <input type="email" name="email" required placeholder="tu@empresa.com" value={heroEmail} onChange={(e) => setHeroEmail(e.target.value)}
            ...
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '0.78rem', color: 'rgba(255,255,255,0.45)', marginTop: 0, marginBottom: '20px' }}>Sin compromiso &middot; Respuesta en 24h &middot; Pide presupuesto</p>
            ...
            {/* Testimonio corto */}
            <p style={{ fontFamily: 'var(--font-sans)', fontSize: '13.5px', color: 'rgba(255,255,255,0.7)', lineHeight: 1.6, maxWidth: '480px', margin: '0 0 24px', borderLeft: '2px solid var(--gold)', paddingLeft: '14px' }}>
              <em>"El pliego cerraba en 5 semanas y no teníamos ENS. Avson arrancó en 48h y certificamos a tiempo. Presentamos la oferta y la ganamos."</em> — Director de Sistemas
            </p>
          ...
          <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap', marginTop: '52px', paddingTop: '40px', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <div>
              <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '36px', fontWeight: 700, color: 'var(--gold)', lineHeight: 1 }}>24h</div>
            ...
            <div>
              <div style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: '36px', fontWeight: 700, color: 'var(--gold)', lineHeight: 1 }}>6</div>
      ...
      <section className="section section--pearl">
        <div className="container">
          <div className="anim-fade-up" style={{ maxWidth: '640px', marginBottom: '48px' }}>
            ...
            <div className="gold-line"></div>
            <h2 className="section-title">Si tienes un pliego que cierra pronto,<br />no hay tiempo que perder.</h2>
