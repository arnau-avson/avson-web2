...
<h2>Preguntas frecuentes</h2>
    ...
    <div className="faq-article">
      ...
      <div className="faq-article-item">
        ...
        <div className="faq-article-a">La categoría (Básica, Media o Alta) depende de la valoración del impacto potencial de un incidente de seguridad en los sistemas en alcance. La mayoría de pymes TIC proveedoras del sector público necesitan ENS Básica o Media. El diagnóstico gratuito de Avson determina exactamente qué categoría te aplica.</div>
      </div>
      <div className="faq-article-item">
