...
<section style={{padding:'80px 0'}}>
  <div className="container">
    <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'24px'}}>
      ...
      <Link to="/blog/ens-basico-guia-empresas" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/ens-sector-salud" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/gap-analysis-ens" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/auditoria-ens-proceso" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/declaracion-conformidad-ens" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
        <span style={{fontFamily:"'Inter',sans-serif",fontSize:'11px',fontWeight:'500',letterSpacing:'0.1em',textTransform:'uppercase',color:'#C9A84C',display:'block',marginBottom:'12px'}}>ENS Básico</span>
      ...
      <Link to="/blog/que-es-el-ens" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/certificado-ens-obligatorio" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/certificado-ens-media-alta" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/ens-vs-iso27001" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/iso27001-pymes" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/renovacion-certificado-ens" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/cuanto-cuesta-certificado-ens" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/iso27001-requisitos-certificacion" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/que-es-iso22301" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/plan-continuidad-negocio" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/que-es-dora-reglamento" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/dora-entidades-financieras" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/que-es-nis2-directiva" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
      ...
      <Link to="/blog/que-es-tisax" style={{display:'block',border:'1px solid var(--border)',padding:'32px',textDecoration:'none',transition:'border-color 0.2s'}} onMouseOver={(e) => (e.currentTarget.style.borderColor = '#C9A84C')} onMouseOut={(e) => (e.currentTarget.style.borderColor = '#E5E5E0')}>
...
<section className="section section--navy" style={{textAlign:'center'}}>
  <div className="container">
    <div style={{maxWidth:'600px',margin:'0 auto'}}>
      ...
      <p className="mt-24" style={{fontSize:'17px',color:'rgba(255,255,255,0.5)',lineHeight:'1.65'}}>Pide presupuesto. Sin compromiso. Respuesta en 24 horas.</p>
