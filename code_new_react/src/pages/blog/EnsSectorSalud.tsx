...
<article style={{padding:'72px 0 80px',background:'var(--white)'}}>
  <div className="article-body">
    ...
    <div style={{background:'#F7F7F5',border:'1px solid #E5E5E0',borderLeft:'3px solid #C9A84C',padding:'28px 32px',display:'flex',alignItems:'center',justifyContent:'space-between',gap:'24px',flexWrap:'wrap',margin:'40px 0'}}>
      <span style={{fontFamily:"'Cormorant Garamond',serif",fontSize:'20px',fontWeight:'400',color:'#1A2744',lineHeight:'1.3',flex:'1',minWidth:'200px'}}>Avson GRC tiene experiencia específica certificando proveedores TIC del sector sanitario en toda España. Pide presupuesto, respuesta en 24 horas.</span>
    ...
    <div className="faq-article">
      <div className="faq-article-item">
        <div className="faq-article-q" onClick={(e) => (e.currentTarget as HTMLElement).closest('.faq-article-item')?.classList.toggle('open')}>¿Los hospitales privados necesitan el ENS?</div>
      ...
      <div className="faq-article-item">
        <div className="faq-article-q" onClick={(e) => (e.currentTarget as HTMLElement).closest('.faq-article-item')?.classList.toggle('open')}>¿Qué categoría ENS necesita un proveedor de historia clínica electrónica?</div>
      ...
      <div className="faq-article-item">
        <div className="faq-article-q" onClick={(e) => (e.currentTarget as HTMLElement).closest('.faq-article-item')?.classList.toggle('open')}>¿El ENS en salud incluye la protección de datos de pacientes?</div>
      ...
      <div className="faq-article-item">
        <div className="faq-article-q" onClick={(e) => (e.currentTarget as HTMLElement).closest('.faq-article-item')?.classList.toggle('open')}>¿Cuánto tiempo lleva el ENS para una empresa de software sanitario?</div>
      ...
      <div className="faq-article-item">
        <div className="faq-article-q" onClick={(e) => (e.currentTarget as HTMLElement).closest('.faq-article-item')?.classList.toggle('open')}>¿El ENS es compatible con ISO 27001 en el sector salud?</div>
    ...
    <div style={{marginTop:'64px',padding:'40px',background:'var(--pearl)',border:'1px solid var(--border)',textAlign:'center'}}>
      ...
      <p style={{fontFamily:"'Inter',sans-serif",fontSize:'15px',color:'var(--text-muted)',margin:'0 0 28px',maxWidth:'500px',marginLeft:'auto',marginRight:'auto'}}>Pide presupuesto especializado · Toda España · Respuesta en 24 horas</p>
