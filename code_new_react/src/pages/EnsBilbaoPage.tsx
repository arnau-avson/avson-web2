...
<section className="hero">
  ...
  <section className="section section--white">
    <div className="container">
      ...
      <p className="section__body">Si tu empresa está en Navarra, La Rioja, Cantabria, Asturias o Galicia, Avson GRC puede atenderte con el mismo nivel de servicio. Consulta nuestra <Link to="/consultoria-ens-espana.html" style={{color:'var(--gold)',fontWeight:'500'}}>cobertura nacional completa</Link>.</p>
    </div>
  </section>
    ...
    <div className="container">
      ...
      <div className="faq-list">
        ...
        <div className="faq-item anim-fade-up">
          ...
          <div className="faq-item__a">
            <p>El coste es el mismo que en cualquier otra ciudad española: desde 4.000 € para ENS básico hasta más de 18.000 € para ENS alto. No aplicamos recargos por desplazamiento al País Vasco. El <Link to="/contacto.html" style={{color:'var(--gold)'}}>diagnóstico gratuito</Link> incluye propuesta personalizada sin compromiso.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <section className="section section--navy">
    <div className="container" style={{textAlign:'center',maxWidth:'700px'}}>
      ...
      <p className="section__lead section__lead--white" style={{margin:'0 auto 36px'}}>Escríbenos tu email y te enviamos un diagnóstico gratuito en 48 horas. Reunión por videollamada o presencial en Bilbao.</p>
