    ...
    <>
        ...
        <div className="container">
          ...
          <div className="process-grid">
            ...
            <div className="process-card anim-fade-up">
              ...
              <p className="process-card__text">Coordinamos con entidad certificadora acreditada por ENAC. Pre-auditoría interna para garantizar el éxito. 98% de éxito en primera auditoría.</p>
            </div>
            <div className="process-card anim-fade-up">
      ...
      <section className="section section--navy">
        <div className="container" style={{ textAlign: 'center', maxWidth: '700px' }}>
          ...
          <p className="section__lead section__lead--white" style={{ margin: '0 auto 36px' }}>Escríbenos tu email y te enviamos un presupuesto sin compromiso en 48 horas. Reunión por videollamada o presencial en Valencia.</p>
