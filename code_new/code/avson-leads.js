...
function avsonShowFieldError(form, msg) {
  ...
  if (!el) {
    ...
    el.style.cssText = "color:#dc2626;font-family:Inter,sans-serif;font-size:13px;line-height:1.4;margin-top:8px";
    form.appendChild(el);
  }
  el.textContent = msg;
  ...
  function mount() {
    ...
    if (isMobile()) {
      ...
      x.style.cssText = [
        ...
        "background:#1A2744", "color:#fff", "font-size:16px", "line-height:1",
    ...
    a.onmouseover = function () { a.style.background = "#D9B84D"; a.style.paddingRight = "14px"; };
    a.onmouseout  = function () { a.style.background = "#C9A84C"; a.style.paddingRight = "11px"; };
